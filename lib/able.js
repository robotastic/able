...
var LocalCharacteristic = require('./local-characteristic');
...
Able.prototype.Characteristic = LocalCharacteristic;
...
Able.prototype.findHandlesForUuid = function(uuid)
{
  this._bindings.findByTypeRequest(0x0001,0xffff, 0x2800, uuid);
}
