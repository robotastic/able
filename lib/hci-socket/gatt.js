...
Gatt.prototype.onAclStreamData = function(cid, data) {
  ...
  debug('Recieved Packet type: ' + requestType  + " Data: " + request.toString('hex'));
  switch(requestType) {
    case ATT_OP_ERROR:
      debug('ATT_OP_ERROR: ');
...
Request Op Code in error: ' + request[1] + ' Handle in Error: ' + request.readUInt16LE(3) + " Error code: " + request[6]);
