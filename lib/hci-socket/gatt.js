...
Gatt.prototype.readByGroupRequest = function(startHandle, endHandle, groupUuid) {
  ...
  debug('Sending ATT_OP_READ_BY_GROUP_REQ - startHandle: ' + printBuf.writeUInt16LE(startHandle,0).toString('hex') + ' endHandle: ' + printBuf.writeUInt16LE(endHandle,0).toString('hex') + ' Group UUID: ' + printBuf.writeUInt16LE(groupUuid,0).toString('hex'));
